...
-file("src/lists/list_parser.yrl", 17).
...
-file("src/lists/list_parser.yrl", 6).
...
-file("src/lists/list_parser.yrl", 3).
...
-file("src/lists/list_parser.yrl", 10).
...
-file("src/lists/list_parser.yrl", 9).
...
-file("src/lists/list_parser.yrl", 7).
...
-file("src/lists/list_parser.yrl", 4).
...
-file("src/lists/list_parser.yrl", 20).
