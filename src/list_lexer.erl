...
-file("src/lists/list_lexer.xrl", 22).
...
yystate(11, Ics, Line, Tlen, _, _) ->
    {5,Tlen,Ics,Line};
yystate(10, [102|Ics], Line, Tlen, Action, Alen) ->
...
-file("src/lists/list_lexer.xrl", 9).
yyaction_0(TokenChars, TokenLine) ->
     { token, { define, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("src/lists/list_lexer.xrl", 10).
yyaction_1(TokenChars, TokenLine) ->
     { token, { table, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("src/lists/list_lexer.xrl", 11).
yyaction_2(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("src/lists/list_lexer.xrl", 12).
yyaction_3(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, to_atom (TokenChars) } } .

-compile({inline,yyaction_4/1}).
-file("src/lists/list_lexer.xrl", 13).
yyaction_4(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/lists/list_lexer.xrl", 14).
yyaction_5(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/lists/list_lexer.xrl", 15).
yyaction_6(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/lists/list_lexer.xrl", 16).
yyaction_7(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/lists/list_lexer.xrl", 17).
yyaction_8(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_9/0}).
-file("src/lists/list_lexer.xrl", 18).
yyaction_9() ->
     skip_token .
